...
python ./src/adl_to_csv.py MIX \
       --path-input-root-dir-acc   /root/dataStore_upconversion/data/${root_dir}/ADL/ADL_${entry}/acc2 \
       --path-input-root-dir-gyro  /root/dataStore_upconversion/data/${root_dir}/ADL/ADL_${entry}/Gyro \
       --path-input-xml            None \
       --path-output-dir           /root/dataStore_upconversion/data/${root_dir}/CSV/ \
       --filename-csv              ${prefix}_1000Hz_sub${sub_id}_mix.csv \
       --filename-label            ${prefix}_sub${sub_id}_label_detail.csv \
